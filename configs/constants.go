...
const (
	...
	ProjectAccessLogFile = "./log/logs/" + ProjectName + "-access.log"

	// ProjectBizLogFile 项目后台业务日志存放文件
	ProjectBizLogFile = "./log/logs/" + ProjectName + "-biz.log"
